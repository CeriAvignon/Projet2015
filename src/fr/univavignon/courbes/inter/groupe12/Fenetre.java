...
/**
 * @author groupe12
 * Classe Fenetre héritant de la classe JMenuBar qui nous permet de créer des fenetre  
 */

public class Fenetre extends JMenuBar {

   String[ ] fileItems = new String[ ] { "Nouveau", "Ouvrir", "Sauvegarder", "Quitter" };
      ...
      ActionListener printListener = new ActionListener(  ) {
         public void actionPerformed(ActionEvent event) {
            System.out.println("Menu item [" + event.getActionCommand(  ) +
                               "] was pressed.");
            if(event.getActionCommand()=="Quitter"){
            	System.exit(0);
            }else if(event.getActionCommand()=="Nouveau"){
