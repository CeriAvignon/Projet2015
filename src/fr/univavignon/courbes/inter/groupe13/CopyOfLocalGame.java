...
public class CopyOfLocalGame extends JFrame{
...
//		playerPanel.setMaximumSize(new Dimension(500, 500));
		...
		jb_back.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				CopyOfLocalGame.this.dispatchEvent(new WindowEvent(CopyOfLocalGame.this, WindowEvent.WINDOW_CLOSING));
				CopyOfLocalGame.this.m.setVisible(true);
		...
		jb_start.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(isReadyToStartGame()){
					...
					JOptionPane.showMessageDialog(CopyOfLocalGame.this, "<html>Les données des joueurs locaux ne sont pas correctement remplies. Vérifiez que :" +
