 ...
 */
public class CopyOfMenu extends Window{
...
//				new Game(width, height);
		...
		serverGame.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				setVisible(false);
				new ServerGame(CopyOfMenu.this);
//				new Network(width, height, false);
		...
		clientGame.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				setVisible(false);
				new JoinServer(CopyOfMenu.this);
//				new Network(width, height, true);
		...
		quit.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				CopyOfMenu.this.dispatchEvent(new WindowEvent(CopyOfMenu.this, WindowEvent.WINDOW_CLOSING));
			}
		});
		...
		profils.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				DisplayProfileFrame df = new DisplayProfileFrame(CopyOfMenu.this);
				CopyOfMenu.this.setVisible(false);
			}
		});
