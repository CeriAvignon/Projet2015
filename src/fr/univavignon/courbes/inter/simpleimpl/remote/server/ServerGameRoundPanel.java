...
{	/** Numéro de série de la classe */
	...
	{	// aspects réseau
		...
		clientIndices = new Integer[temp.size()];
		clientIndices = temp.toArray(clientIndices);
	...
	{	// réinitialisation locale
		...
		while(readyClientNbr<clientIndices.length)
		{	try
			{	wait();
			}
...
// TODO côté serveur, faut se tenir informé des déconnexions des clients
// TODO pareil côté client. en distinguant les cas où la partie est finie (pas besoin de message d'erreur)
