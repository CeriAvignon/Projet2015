...
public class Controle {
	...
	public static int controlePseudo(String ps) {	
	    ...
	    BufferedReader bis;        
	    try {
	      fis = new FileInputStream(new File("src/fr/univavignon/courbes/inter/groupe09/txt/user.txt"));
	...
	public int controleConnexion(String ps,String mdp){
	    ...
	    try {
	      fis = new FileInputStream(
	    		  new File("src/fr/univavignon/courbes/inter/groupe09/txt/user.txt"));
	      isr = new InputStreamReader(fis);
	      bis = new BufferedReader(isr);
	...
	public int idPlayer() {
		...
		try {
			fis = new FileInputStream("src/fr/univavignon/courbes/inter/groupe09/txt/user.txt");
		} 
		catch (FileNotFoundException e) {
 ...
 */
	public void inscriptionDe(String email, String ps, String mdp,String pays, String temps ,int score ) {
		...
		try {
			BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream("src/fr/univavignon/courbes/inter/groupe09/txt/user.txt")));
		    ...
		    BufferedWriter out = new BufferedWriter( new FileWriter("src/fr/univavignon/courbes/inter/groupe09/txt/user.txt"));
