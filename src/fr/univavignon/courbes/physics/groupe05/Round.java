...
public class Round implements PhysicsEngine {
	...
	public Snake snakeCreator(Snake snake, int playerId, int profileId, int currentX, int currentY, double currentAngle=0, double headRadius=1, double movingSpeed=0.5, double turningSpeed=1, boolean state=true, boolean collision=true, boolean inversion=false, double holeRate=0, boolean fly=false, int currentScore=0) {
