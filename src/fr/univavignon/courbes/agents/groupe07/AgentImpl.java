                        ...
                        {        // on récupère le serpent de l'agent
                                ...
                                {        updateAngles();
                                        ...
                                        {        checkInterruption();        // on doit tester l'interruption au début de chaque boucle
                                                ...
                                                if(i != getPlayerId() || i == getPlayerId())
...
private boolean isInSightNormal(double angle){
        ...
        boolean result = AngleLowerBound && AngleUpperBound;
...
private boolean isInSightUPPERDeuxPI(double angle){
        ...
        boolean result = AngleDeuxPI && AngleUpperBoundPI;
...
private boolean isTooCloseToCorner(){
        ...
        boolean result =resultX && resultY;
