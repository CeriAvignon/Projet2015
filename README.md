...
Vous ne travaillerez *que* sur cette branche, vous ne devre *en aucun cas* modifier les autres branches, y compris et surtout la branche principale.

Une fois la branche créée, définissez un nouveau package dans `fr.univavignon.courbes``afin d'y placer votre code source.
L'intégralité de votre code source doit être contenu dans ce package. Effectuez des commits le plus régulièrement possible,
